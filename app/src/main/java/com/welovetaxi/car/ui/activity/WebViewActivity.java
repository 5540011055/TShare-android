...
public class WebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://www.welovetaxi.com/app/demo_new/index.php");
    ...
    public boolean onKeyDown(int keyCode, @NonNull KeyEvent event) {
        /**Toast.makeText(WebViewActivity.this,"Event: onKeyDown =="+keyCode,Toast.LENGTH_SHORT).show();
    ...
    public class WebAppInterface {
        ...
        @JavascriptInterface
        public void showToast(String txt,String username) {
            /**Toast.makeText(WebViewActivity.this
                    , "Hello WebView ::"+txt
                    , Toast.LENGTH_SHORT).show(); **/
            OneSignal.sendTag("class", txt);
